...
if (
    $pmp_thumbnail_cache &&
    is_file("../cache/graph_origins_" . $graph_lang . ".png")
) {
    $filename = "../cache/graph_origins_" . $graph_lang . ".png";
    ...
    $query =
        'SELECT name AS origin, data AS count FROM pmp_statistics WHERE type = \'origins\' ORDER BY LPAD(data, 20, \'0\') DESC';
    $result = dbexec($query);
