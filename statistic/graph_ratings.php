...
if (
    $pmp_thumbnail_cache &&
    is_file("../cache/graph_ratings_" . $graph_lang . ".png")
) {
    $filename = "../cache/graph_ratings_" . $graph_lang . ".png";
    ...
    $query =
        'SELECT name AS rating, data AS count FROM pmp_statistics WHERE type = \'ratings\' ORDER BY LPAD(data, 20, \'0\') DESC';
    $result = dbexec($query);
