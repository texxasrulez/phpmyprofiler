...
if (
    $pmp_thumbnail_cache &&
    is_file("../cache/graph_regions_" . $graph_lang . ".png")
) {
    $filename = "../cache/graph_regions_" . $graph_lang . ".png";
    ...
    $query =
        'SELECT name AS region, data AS count FROM pmp_statistics WHERE type = \'regions\' GROUP BY region';
    $result = dbexec($query);
