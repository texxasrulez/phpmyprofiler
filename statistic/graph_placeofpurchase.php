...
require_once "../include/jpgraph/themes/pmpTheme.class.php";
...
if (
    $pmp_thumbnail_cache &&
    is_file("../cache/graph_placeofpurchase_" . $graph_lang . ".png")
) {
    $filename = "../cache/graph_placeofpurchase_" . $graph_lang . ".png";
    ...
    $query =
        'SELECT name AS purchplace, data AS count FROM pmp_statistics WHERE type = \'purchplace_top10\' ORDER BY LPAD(data, 20, \'0\') DESC';
    $result = dbexec($query);
    ...
    if ($rows == 0) {
        ...
        $graph = new Graph(
            550,
            12 * $rows + 40,
            "graph_placeofpurchase_" . $graph_lang . ".png",
        );
