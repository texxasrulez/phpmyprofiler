...
if (
    $pmp_thumbnail_cache &&
    is_file("../cache/graph_studios_" . $graph_lang . ".png")
) {
    $filename = "../cache/graph_studios_" . $graph_lang . ".png";
    ...
    $query =
        'SELECT name AS studio, data AS count FROM pmp_statistics WHERE type = \'studios_top10\' ORDER BY LPAD(data, 20, \'0\') DESC';
    $result = dbexec($query);
    ...
    if (mysql_num_rows($result) == 0) {
        ...
        // Setup the graph
        $graph = new Graph(550, 160, "graph_studios_" . $graph_lang . ".png");
