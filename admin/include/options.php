...
$Options[] = new option(
    "pmp_checkforupdates",
    "Check for updates",
    "Contact www.genesworld.net when entering the admin-menu and check if a new version is available.",
    $pmp_checkforupdates,
    [1 => "Yes", 0 => "No"],
);
...
$Options[] = new option("pmp_dateformat", "Date format", "", $pmp_dateformat, [
    "%m/%d/%y" => "MM/DD/YY",
    "%d.%m.%Y" => "DD.MM.YYYY",
    "%Y/%m/%d" => "YYYY-MM-DD",
]);
...
$Options[] = new option("pmp_dec_point", "Decimal point", "", $pmp_dec_point, [
    "." => "point",
    "," => "comma",
]);
$Options[] = new option(
...
$Options[] = new option(
    ...
    "You need to use true type fonts for languages with special characters (eg. Norwegian &Oslash;)",
    $pmp_stat_use_ttf,
    [1 => "Yes", 0 => "No"],
);
$Options[] = new option(
...
$Options[] = new option(
    "pmp_start_sort_order",
    "Sort order of latest DVDs",
    "",
    $pmp_start_sort_order,
    ["collectionnumber" => "Number", "purchdate" => "Date of purchase"],
);
$Options[] = new option(
    "pmp_statistic_showprice",
