...
$phpinfo = preg_replace(
    "#<table#",
    '<table class="phpinfo" align="center"',
    $phpinfo[1][0],
);
$phpinfo = preg_replace(
...
$phpinfo = preg_replace(
    ...
    '<td align="center" style="text-align: center"><a href="http://www.php.net/">',
    $phpinfo,
);
$phpinfo = preg_replace(
    '#<td>\n<a href="http://www.zend.com/">#',
    '<td align="center" style="text-align: center; background-color: #cccccc"><a href="http://www.zend.com/">',
    $phpinfo,
);
$phpinfo = preg_replace(
    '#alt="Zend logo" /></a>#',
...
$phpinfo = preg_replace(
    '#<a name="module_Zend Optimizer">#',
    '<a name="module_Zend_Optimizer">',
    $phpinfo,
);
