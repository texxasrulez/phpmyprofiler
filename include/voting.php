...
if ($pmp_gdlib == true) {
    if (isset($size) && $size == "big") {
        ...
        $img_dest = imagecreatefrompng(
            "../themes/" . $pmp_theme . "/images/vote/b_empty.png",
        );
        $img_full = imagecreatefrompng(
            "../themes/" . $pmp_theme . "/images/vote/b_full.png",
        );
        ...
        imagettftext(
            ...
            80,
            0,
            "../themes/" . $pmp_theme . "/images/vote/font.ttf",
            $rating_big,
        );
        imagettftext(
            $img_dest,
        ...
        // Get back- & foreground pics
        $img_dest = imagecreatefrompng(
            "../themes/" . $pmp_theme . "/images/vote/s_empty.png",
        );
        $img_full = imagecreatefrompng(
            "../themes/" . $pmp_theme . "/images/vote/s_full.png",
        );
