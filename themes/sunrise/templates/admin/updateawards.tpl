...
<div id="mainpanel">
	...
	<div align="left" style="text-align: left;">
		...
		{foreach from=$Files item=file}
			...
			<td align="left" style="text-align: left;">
			    <a class="button" href="updateawards.php?action=parse&amp;file={$file.name|rawurlencode}&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/parse.gif" border="0" alt="{t}Parse{/t}" />{t}Parse{/t}</a>
			    <a class="button" href="updateawards.php?action=delete&amp;file={$file.name|rawurlencode}&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/recyclebin.gif" border="0" alt="{t}Delete{/t}" />{t}Delete{/t}</a>
			</td>
		    </tr>
		{/foreach}
	    </table>
	...
	<div align="left" style="text-align: left;">
		...
		{foreach from=$Types item=type}
			...
			<td align="left" style="text-align: left;">
			    <a class="button" style="display: inline;" href="updateawards.php?action=deleteaward&amp;award={$type|rawurlencode}&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/recyclebin.gif" border="0" alt="{t}Delete{/t}" />{t}Delete{/t}</a>
			</td>
			<td align="left" style="text-align: left;">
			    <a class="button" style="display: inline;" href="updateawards.php?action=buildtags&amp;award={$type|rawurlencode}&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/tag.png" border="0" alt="{t}Build tags{/t}" />{t}Build tags{/t}</a>
			</td>
		    </tr>
		{/foreach}
	    </table>
    ...
    <form enctype="multipart/form-data" method="post" action="uploadaward.php?{$csrf_token_url}" style="visibility: inline" accept-charset="utf-8">
