...
<div id="mainpanel">
	...
	<div class="box" style="text-align:left; margin-left:auto; margin-right:auto; width: 460px; margin-bottom: 15px">
	    <form enctype="multipart/form-data" method="post" action="pictures.php?action=add&amp;{$csrf_token_url}" style="visibility: inline" accept-charset="utf-8">
	...
	<table class="tabelle" cellspacing="0" cellpadding="3" border="0">
		...
		<tr>
		    ...
		    <td class="td{$sch%2}">
			<a href="pictures.php?action=delete&amp;id={$pic->id}&amp;{$csrf_token_url}" class="button"><img src="../themes/{$pmp_theme}/images/recyclebin.gif" alt="{t}Delete{/t}" border="0" />{t}Delete{/t}</a>
		    </td>
		</tr>
	    {/foreach}
	</table>
