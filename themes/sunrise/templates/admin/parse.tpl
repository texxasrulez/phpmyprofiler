...
<div id="mainpanel">
	...
	<div align="left" style="text-align: left">
		...
		{foreach from=$Files item=file}
			...
			<td align="left" style="text-align: left;">
			    {if $pmp_parser_mode == 0}
					<a class="button" href="parse.php?action=split&amp;file={$file.name|rawurlencode}&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/parse.gif" border="0" alt="{t}Parse{/t}" />{t}Parse{/t}</a>
				{else}
					<a class="button" href="parse.php?action=parse&amp;file={$file.name|rawurlencode}&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/parse.gif" border="0" alt="{t}Parse{/t}" />{t}Parse{/t}</a>
				{/if}
				<a class="button" href="parse.php?action=delete&amp;file={$file.name|rawurlencode}&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/recyclebin.gif" border="0" alt="{t}Delete{/t}" />{t}Delete{/t}</a>
			</td>
		    </tr>
		{/foreach}
	    </table>
    ...
    <form enctype="multipart/form-data" method="post" action="uploadxml.php?{$csrf_token_url}" style="visibility: inline" accept-charset="utf-8">
