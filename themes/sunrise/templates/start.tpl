...
<div>
	...
	<table class="frame">
		<tr>
			<td colspan="2" class="frame-content">
				{t}Built by{/t}&nbsp;<a href="http://www.genesworld.net">phpMyProfiler&nbsp;{$pmp_version}</a>&nbsp;-&nbsp;{t}published under General Public License (GPL){/t}{if isset($last_update)}&nbsp;-&nbsp;{t}Last update{/t}&nbsp;{$last_update}{/if}
			</td>
		</tr>
	</table>
