...
{if !isset($show) || $show == 0}
	<div id="mainpanel">
		<div align="left" style="text-align: left;">
			<form enctype="multipart/form-data" action="screenshots.php?action=upload&amp;{$csrf_token_url}" method="post" target="_self" style="display: inline" accept-charset="utf-8">
				<table cellpadding="0" cellspacing="0" border="0" class="tabelle" style="width: 800px;">
					...
					<tr>
						...
						<td align="left" style="text-align: left;" colspan="2">
							{if isset($indb)}
								<a class="button" href="screenshots.php?action=buildtags&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/tag.png" border="0" alt="{t}Build tag{/t}" />{t}Build tag{/t}</a>
							{else}&nbsp;{/if}
						</td>
					</tr>
				</table>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="tabelle" style="width: 800px">
					...
					{foreach from=$notindb item=id}
						<tr>
							...
							<td class="td{$i%2}">
								<a class="button" style="display: inline;" href="screenshots.php?action=delete&amp;id={$id|escape:"url"}&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/recyclebin.gif" border="0" alt="{t}Delete{/t}" />{t}Delete{/t}</a>
							</td>
							<td class="td{$i%2}">
								<a class="button" style="display: inline;" href="screenshots.php?action=show&amp;id={$id|escape:"url"}&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/show.png" border="0" alt="{t}Show{/t}" />{t}Show{/t}</a>
							</td>
						</tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="tabelle" style="width: 800px">
					...
					{foreach from=$indb item=id}
						...
						<tr>
							...
							<td class="td{$i%2}">
								<a class="button" style="display: inline;" href="screenshots.php?action=delete&amp;id={$id.id|escape:"url"}&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/recyclebin.gif" border="0" alt="{t}Delete{/t}" />{t}Delete{/t}</a>
							</td>
							<td class="td{$i%2}">
								<a class="button" style="display: inline;" href="screenshots.php?action=show&amp;id={$id.id|escape:"url"}&amp;{$csrf_token_url}"><img src="../themes/{$pmp_theme}/images/show.png" border="0" alt="{t}Show{/t}" />{t}Show{/t}</a>
							</td>
						</tr>
						{assign var=i value=$i+1}
					{/foreach}
...
{else}
	<div id="mainpanel">
		<form action="screenshots.php?action=relink&amp;id={$id|escape:"url"}&amp;{$csrf_token_url}" method="post" target="_self" style="display: inline" accept-charset="utf-8">
